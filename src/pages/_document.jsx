...
export default function Document() {
  return (
    <Html lang="en" title="Oscar Alonso - Sr. Help Desk Analyst & Frontend Developer | Uruguay">
      <Head>
        {/* Google Tag Manager */}
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-NNMLJS6C');</script>
      ...
      <body id="root" className="bg-zinc-900 text-zinc-50">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NNMLJS6C" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
